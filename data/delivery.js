const PROMO = {
  backgroundImage: {
    desktop: '/images/info/delivery.png',
    mobile: '/images/info/delivery-mobile.png'
  },
...
const TEXT_INFO = {
  columns: [
    ...
    {
      title: '2 hours',
      text: 'delivery in london within the zones 7'
    }
  ],
...
const HERO_ITEMS = [
  {
    ...
    text: "Urgent flower delivery is not carried out \non holidays - New Year, Valentine's Day, \nMarch 8, Mother's Day and pre-holidays"
  },
  {
    title: 'Help',
    text: 'If you have any questions, please contact our managers by phone'
  },
  {
    title: 'Delivery time',
...
const ADVERTISING = [
  {
    image: '/images/info/flowers-2.png',
    backgroundColor: '#D3F3FF',
    title: 'Premium bouquets',
    text: 'For an exceptional and special occasion'
  },
  {
    image: '/images/info/flowers-2.png',
