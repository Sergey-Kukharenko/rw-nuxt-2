    ...
    <div class="delivery-details__address">
      ...
      >
        <template #default="{ item, close, setLabel }">
          <div
            class="delivery-details__address-item"
            @click="onClickAddressItem(item, close, setLabel)"
          >
            ...
            <div
              class="delivery-details__address-item-right"
              @click.stop="editAddress(item, close)"
            >
              <svg-icon
                class="delivery-details__icon-edit"
                name="edit"
              />
            </div>
          </div>
...
export default {
  ...
  components: {AppTextarea, AppRadio, AppInput, AppSelect, CheckoutModal },
  data() {
    return {
      addressSelect: '',
    };
